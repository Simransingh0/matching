        ...
        <div class="card shadow-lg border-0 rounded-4 bg-white p-4 p-md-5">
            <form action="<?php echo e(route('projects.update', $project->id)); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" class="form-control" value="<?php echo e($project->title); ?>" required>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold">Beschrijving</label>
                    <textarea name="description" class="form-control" rows="4"><?php echo e($project->description); ?></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="required_skills" class="form-control" 
                        value="<?php echo e(implode(', ', json_decode($project->required_skills, true) ?? [])); ?>">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Simran\Herd\matching-platform\resources\views/projects/edit.blade.php ENDPATH**/ ?>